  ...
  await page.evaluate(() => {
    ...
    w.__STORE_FOR_TEST__.setState({
      project: {
        ...
        transcript: [],
        broll_points: [
          { id: "bp_01", phrase: "first phrase", t_start: null, t_end: null, keywords: ["k1"], active_keyword: "k1", status: "downloading", selected_video: { video_id: "abc", title: "Vid A", channel: "Ch", duration_sec: 60, thumb_url: "", url: "https://www.youtube.com/watch?v=abc" }, output_clip: null },
      ...
      currentIndex: 0,
      searchResults: { bp_01: [{ video_id: "vidx", title: "Search result A", channel: "Ch X", duration_sec: 90, thumb_url: "", url: "https://www.youtube.com/watch?v=vidx" }] },
